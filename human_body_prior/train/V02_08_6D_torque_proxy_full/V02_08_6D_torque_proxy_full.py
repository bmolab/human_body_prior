r"""6DOF VPoser training with auxiliary torque_proxy supervision.

Example:
    python -m human_body_prior.train.V02_08_6D_torque_proxy.V02_08_6D_torque_proxy \
        --dataset-dir D:\Git\human_body_prior\AMASS\DataSet\SFU_test_torque_proxy \
        --expr-id V02_08_6D_torque_proxy
"""
...
def main():
    ...
    parser.add_argument("--expr-id", default="V02_08_6D_torque_proxy_full")
    ...
    print("Torque-proxy training dataset_dir:", dataset_dir)
    print("Torque-proxy training work_dir:", osp.join(vp_ps.general.work_basedir, vp_ps.general.expr_id))
    print("Torque-proxy training epochs:", vp_ps.train_parms.num_epochs)
    print("Torque-proxy training batch_size:", vp_ps.train_parms.batch_size)
    print("Torque-proxy training lr:", vp_ps.train_parms.gen_optimizer.args.lr)
    print("Torque-proxy training gradient_clip_val:", vp_ps.train_parms.gradient_clip_val)
    print("Torque-proxy training loss_torque_proxy_wt:", vp_ps.train_parms.loss_weights.loss_torque_proxy_wt)
    print("Torque-proxy training bm_fname:", vp_ps.body_model.bm_fname)
